...
\begin{document}
    ...
    \hrule
    \kern 3.0 pt%
    Electrical/Computer Engineer interested in the intersection of control systems, signal processing, and embedded systems. 
    \section{Education}
    ...
    \section{Technical Experience}
        \textbf{Virginia Tech \boldmath$\cdot$ Robotics Research}\\
    \begin{twocolentry}{{Aug 2023 -- May 2025} \\\textit{Blacksburg, Virginia}}
        \textbf{\textit{Robotics Researcher}}\\
        \begin{onecolentry}
            \begin{highlights}
                \item Developing a 6-axis robotic manipulator and an accompanying ROS2–Gazebo \& MuJoCo simulation using Gymnasium for deploying custom reinforcement learning algorithms.
                \item Integrating CNN-based object detection (YOLOv8), RNN-based language parsing, symbolic reasoning, and a DDPG-based reinforcement learning policy for robotic manipulation tasks.
            \end{highlights}
        \end{onecolentry}
    \end{twocolentry}
    \begin{twocolentry}{{Aug 2024 -- May 2025} \\\textit{Blacksburg, Virginia}}
        \textbf{\textit{Graduate Teaching Assistant}}\\
        \begin{onecolentry}
            \begin{highlights}
            \item Teaching fundamental concepts in linear systems theory and digital signal processing, including Laplace Transforms, Z-Transforms, system stability, and FIR \& IIR filter design.
            \item Assisting with hands-on projects to illustrate and integrate analog and digital filter design and application on breadboards and TI MSP432 development boards.
            \end{highlights}
        \end{onecolentry}
    \end{twocolentry}
    \kern 3.0 pt%
...
\begin{twocolentry}{{May 2024 -- Aug 2024} \\\textit{Huntsville, Alabama \\ (Merrit Island, Florida)}}
    \textbf{\textit{Thrust Vector Control Intern}}\\
        \begin{onecolentry}
            ...
            \item Derived control algorithms for a load-simulating actuator, in Simulink, to simulate external loads placed on the Mars Ascent Vehicle's thrust vector control actuators during flight. 
            \item Designed and integrated IIR filters to remove high frequency noise from a load cell and linear variable differential transformer (LVDT).
            \end{highlights}
        \end{onecolentry}
    \end{twocolentry}
    \kern 3.0 pt%
    ...
    \begin{twocolentry}{{Jun 2022 -- Aug 2022}\\\textit{West Bethesda, Maryland}}
        ...
        \begin{onecolentry}
            \begin{highlights}
            \item Developed concept hospital sea-train designs at the Center for Innovation in Ship Design and estimated fuel consumption and electrical power loads of the concept sea-trains.
            \end{highlights}
        \end{onecolentry}
    \end{twocolentry}
    \section{Skills}
    \textbf{Software: }C/C++, Python, MATLAB, Simulink, GNU/Linux, Git, ROS2, Gazebo, Make, CMake, Labview, Qt,\\
    ...
    \end{twocolentry}
    \kern 3.0 pt%
    \begin{twocolentry}{{Dec 2023 -- May 2024}\\}
