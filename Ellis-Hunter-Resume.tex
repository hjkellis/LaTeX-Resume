...
\ \hrefWithoutArrow{https://hjkellis.github.io}{{hjkellis.github.io}}
\normalsize

\kern -15.0 pt%
\section{}
Engineer focused on building intelligent, capable platforms. I am experienced in developing software for autonomous systems, particularly in the  fields of estimation, motion planning, and control systems.\\
...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Developed a containerized motion planning service with hybrid planning using graph, sampling, and optimization methods.
        % \item Leading an independent research project developing and delivering reactive obstacle avoidance.
        \item Integrated multi-hypothesis tracking (MHT) software, including prediction and data association algorithms for multi-object tracking (MOT) in decentralized swarms with distributed sensor data.
        \item Wrote data association algorithms for multi-object tracking (MOT) and vehicle-to-vehicle track consensus.
        \item Created a world model service for a collaborative-decentralized swarm.
...
\begin{onecolentry}
    \begin{highlights}
    \item Implemented inverter control methods for 4-leg (microgrid) topologies and tested them in Simulink and HIL.
...
\begin{twocolentry}{\textbf{Dec 2029}\\\textit{Atlanta, GA}}
    \textbf{M.S. in Aerospace Engineering} -- \textit{In Progress}\\
    \textit{Georgia Tech $\cdot$ Daniel Guggenheim School of Aerospace Engineering}
\end{twocolentry}
\begin{onecolentry}
    \begin{highlights}
        \item Focus: Flight Mechanics and Control
    \end{highlights}
\end{onecolentry}
\kern 5.0 pt%
