...
\begin{document}
    ...
    \hrule
    \kern 3.0 pt%
    Electrical and Computer Engineer passionate about the intersection of control systems, robotics, and autonomy. 
    \section{Education}
    ...
    \textbf{Virginia Tech $\cdot$ Control, Optimization, and Online Learning for Autonomy Lab}\\
    ...
    \end{twocolentry}
    \kern 3.0 pt%
    \textbf{Jacobs Space Exploration Group $\cdot$ Mars Ascent Vehicle (MAV)}\\
    ...
    \end{twocolentry}
    \kern 3.0 pt%
\textbf{Grenoble Electrical Engineering Laboratory} $\cdot$ Microgrid Inverters\\
    ...
    \end{twocolentry}
    \kern 3.0 pt%
\textbf{Naval Surface Warfare Center (Carderock Division)} $\cdot$ Hospital Sea Trains\\
