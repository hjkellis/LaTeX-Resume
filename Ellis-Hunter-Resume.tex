...
\section{Skills}
\textbf{Software: }C, C++, Python, MATLAB, Simulink,  Git, ROS2, Gazebo, Make, CMake, Labview, Qt, PyTorch, OpenCV, \LaTeX, Verilog, \\
\quad\quad\quad\quad \ \ \ FreeRTOS, Autodesk Inventor (Certified), SolidWorks, Rhino \\
\kern 5.0 pt%
...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Motion planning research for swarm path planning, integrating The Open Motion Planning Library (OPML).
