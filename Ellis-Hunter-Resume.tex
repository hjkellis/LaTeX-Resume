...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Autopilot\newline
        \item Integrated long distance path planning algorithms using The Open Motion Planning Library (OMPL) and GeographicLib into collaborative autonomy software.
