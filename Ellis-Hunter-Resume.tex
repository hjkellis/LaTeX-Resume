...
\begin{onecolentry}
    \begin{highlights}
        ...
        \item Integrated multi-hypothesis tracking software, including prediction and data association algorithms for multi-object tracking (MOT) in decentralized swarms with distributed sensor data.
...
\begin{twocolentry}{(Expected) \textbf{May 2029}\\\textit{Atlanta, GA}}
