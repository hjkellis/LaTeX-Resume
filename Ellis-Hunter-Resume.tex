...
\kern -19.0 pt%
\section{}
Autonomy Engineer with an interest in creating intelligent, capable platforms that can aid humanity.\\
...
\begin{onecolentry}
    \begin{highlights}
        \item Developing C++ software for collaborative autonomous UAV swarms. % Git GNU/Linux and CMake C++14
        \item Integrate, develop, and benchmark sampling-based and optimization-based motion planning algorithms over constraint manifolds leveraging The Open Motion Planning Library (OMPL) and GeographicLib. % may be too wordy
        \item Implement data association algorithms for multi-object tracking (MOT) using distributed camera data from vehicles in a decentralized swarm.\newline
...
\kern 3.0 pt%
\textbf{Tools and Libraries: } ROS2, OMPL, DDS, Qt, Simulink, Docker, Git, FreeRTOS, Autodesk Inventor (Certified), SolidWorks, Rhino \\
\kern 3.0 pt%
