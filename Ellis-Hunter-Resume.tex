...
\kern 3.0 pt%
\textbf{Software: } Git, ROS2, OMPL, DDS, Qt, Simulink, FreeRTOS, Autodesk Inventor (Certified), SolidWorks, Rhino \\
\kern 3.0 pt%
...
\begin{onecolentry}
    \begin{highlights}
        \item Developed C++ software for collaborative autonomous UAV swarms.
        \item Git GNU/Linux and CMake C++14
        \item Software systems integration\newline
        \item Embedded software development\newline
        \item Refactored legacy code to use DDS middleware.
        \item Autopilot\newline
        \item Integrated and benchmarked custom path planning algorithms using The Open Motion Planning Library (OMPL) and GeographicLib into collaborative autonomy software.
        \item Implemented track association algorithms for multi-object tracking.\newline
    \end{highlights}
\end{onecolentry}
\kern 5.0 pt%
...
\begin{twocolentry}{\textbf{May 2024}\\\textit{Blacksburg, VA}}
    ...
    \textbf{B.S. in Electrical \& Computer Engineering (Double Major)} \\
    \textit{Virginia Tech $\cdot$ Bradley Department of Electrical \& Computer Engineering}
\end{twocolentry}
\begin{onecolentry}
    \begin{highlights}
