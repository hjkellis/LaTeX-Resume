...
\section{Skills}
\textbf{Languages: } C++, C, MATLAB,  Lua, \LaTeX \\
\kern 3.0 pt%
\textbf{Software: } Git, ROS2, OMPL, Qt, Simulink, FreeRTOS, Autodesk Inventor (Certified), SolidWorks, Rhino \\
\kern 3.0 pt%
\textbf{Hardware: } PCB Design, Breadboarding, Computer Architecture, Oscilloscope, Multimeter, 3D-Printing \\
\kern 3.0 pt%
